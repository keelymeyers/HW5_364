...
app.config["SQLALCHEMY_DATABASE_URI"] = "postgresql://localhost/keelymHW5"
## Provided:
...
class UpdatePriorityForm(FlaskForm):
    newPriority = StringField("What is the new priority of this task?", validators=[Required()])
    submit = SubmitField('Update')
...
# TODO 364: Fill in the update_item.html template to work properly with this update route. (HINT: Compare against example!)
    ...
    if form.validate_on_submit():
        ...
        n = TodoItem.query.filter_by(id=item.id).first()
